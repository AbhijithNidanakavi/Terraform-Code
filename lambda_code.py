...
#
# {
#   "i-0a45895dd0e299410": "2:00-14:00",
#   "i-04801ebfb326e4779": "18:00-4:00"
# }
#
    ...
    for reservation in res['Reservations']:
        for instance in reservation['Instances']:
            ...
            if instance_id in schedule.keys():
                ec2.create_tags(Resources=[instance_id], Tags=[{'Key':
'Schedule', 'Value': schedule[instance_id]}])
            else:
...
if __name__ == '__main__':
    ...
    event = {'Records': [{'s3': {'bucket': {'name': 'ece592-week10-nidanakavi'},
'object': {'key': 'schedule.json'}}}]}
